...
final _mockArticles = [
  Article(
    ...
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYpZ-H07aQHQZolAFOEYO9e05WlSFy7nuZfQ&s',
...
To continue to enjoy ForestVPN without interruptions, please upgrade to our Premium version.''',
  ...
  Article(
    ...
    imageUrl: 'https://media.istockphoto.com/id/1933022007/photo/descending-mount-snowdon-yr-wyddfa-snowdonia-national-park-gwynedd-wales-uk.jpg?s=612x612&w=0&k=20&c=k5f6eg69fQEWloIc2j7MwDDovFvSrnyOOhVBfTYKAQg=',
    description:
  ...
  Article(
    ...
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpOVqDbnPTm8T1xy1kJjWC_PYftmc6ckbC6Q&s',
    description:
